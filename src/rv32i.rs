...
// TODO: B and J Type Instructions should ignore the right most bit but they ignore the left most bit
// these immediate 12 instructions should probably be immediate 13
